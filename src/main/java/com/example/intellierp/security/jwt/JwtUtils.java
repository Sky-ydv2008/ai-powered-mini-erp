package com.example.intellierp.security.jwt;
...
public class JwtUtils {
    ...
    private SecretKey key() {
        return Keys.hmacShaKeyFor(Decoders.BASE64.decode(ensureBase64(jwtSecret)));
    }

    private String ensureBase64(String secret) {
        // If string is hex or raw ASCII, convert/pad to ensure clean 256-bit key
        if (secret.length() < 32) {
            secret = (secret + "0123456789012345678901234567890123456789").substring(0, 44);
        }
